...
import com.fanwe.live.activity.LiveCreateRoomTopicActivity;
...
public class ShortVideoDetailActivity extends BaseActivity implements TextWatcher, TextView.OnEditorActionListener, TencentLocationListener, SurfaceHolder.Callback {
        ...
        CommonInterface.requestAddVideo(image_path, getTopic(), getCateId(), getCity(), getProvince(), getShareType(), isLocate, isPrivate, new AppRequestCallback<Video_add_videoActModel>() {
            ...
            protected void onSuccess(SDResponse resp) {
                ...
                if (actModel.isOk()) {
                    ...
                    AppRuntimeWorker.createLive(data, ShortVideoDetailActivity.this);
                }else{
